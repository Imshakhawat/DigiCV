...
namespace CVBuilder.Web
{
    public class WebModule:Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<ResumeTemplateCreateModel>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<ResumeTemplateUpdateModel>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<ResumeTemplateListModel>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<ResumeTemplateService>().As<IResumeTemplateService>().InstancePerLifetimeScope();
            builder.RegisterType<CoverLetterCreateModel>().AsSelf().InstancePerLifetimeScope();
            builder.RegisterType<CoverLetterDataModel>().AsSelf()
                .InstancePerLifetimeScope();
            builder.RegisterType<CoverLetterDeleteModel>().AsSelf()
                .InstancePerLifetimeScope();
            builder.RegisterType<CoverLetterUpdateModel>().AsSelf()
                .InstancePerLifetimeScope();
        }
    }
}
